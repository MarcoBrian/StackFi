...
contract DeployVaultFork is Script {
    ...
    function run() external {
        ...
        vault.setAsset(USDC, FEED_USDC_USD, 6, HEARTBEAT, true);
        vault.setAsset(WETH, FEED_ETH_USD, 18, HEARTBEAT, true);

        vm.stopBroadcast();

        console2.log("Vault deployed at:", address(vault));
        console2.log("Router:", UNIV3_ROUTER);
        console2.log("USDC  :", USDC, "feed:", FEED_USDC_USD);
        console2.log("WETH  :", WETH, "feed:", FEED_ETH_USD);
    }
}
